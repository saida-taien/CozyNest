...
const Review = () => {
    return (
        <div  data-aos="flip-up" data-aos-duration="2000" className="flex flex-col max-w-xl p-8 shadow-sm rounded-xl lg:p-12 bg-gray-50 text-gray-800 container mx-auto md:my-32 my-20">
            <div className="flex flex-col w-full">
                <h2 className="text-3xl font-semibold text-center">Customer reviews</h2>
                <div className="flex flex-wrap items-center mt-2 mb-1 space-x-2">
                    <div className="flex">
                        <button type="button" title="Rate 1 stars" aria-label="Rate 1 stars">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-6 h-6 text-yellow-700">
