...
const UserProfile = () => {
    ...
    console.log(user);
    return (
        <div className="container mx-auto my-10 flex flex-col justify-center max-w-xs p-6 shadow-md rounded-xl sm:px-12 dark:bg-gray-50 dark:text-gray-800">
            <Helmet>
                <title>CozyNest|UserProfile</title>
            </Helmet>
